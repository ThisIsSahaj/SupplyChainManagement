    ...
    <div className={`flex-1 items-center mt-8 md:mt-0 md:flex ${
      ...
      <div className="flex-1 gap-x-6 items-center justify-end mt-6 space-y-6 md:flex md:space-y-0 md:mt-0">
        {currentUser ? (
          ...
          className="flex items-center justify-center gap-x-1 py-2 px-4 text-black font-medium bg-transparent hover:bg-black active:bg-gray-900  md:inline-flex border-4 border-black rounded-xl"
          >
            Connect Wallet
          <Nav3 />
          </button>
