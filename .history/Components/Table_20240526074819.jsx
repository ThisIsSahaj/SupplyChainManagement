...
<p className="mt-2 text-gray-600">
  Create a new tracking for your shipment
    ...
    <div className="mt-3 md:mt-3">
      ...
      className="inline-block px-4 py-2 text-white duration-150 frnt-medium bg-black hover:bg-transparent hover:text-black active:bg-gray-900 md:text-sm rounded-lg
